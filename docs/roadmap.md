...
| 13 | 电影海报轮转 | 统一中心位置驱动 12 张海报的空间层级、减速定格与中心敲击 | HyperFrames + CSS 3D + GSAP（已做 [demo](../demos/13-hyperframes-cinematic-coverflow/)） | ✅ |
...
| 17 | 3D 数据地图 | 把区域数据映射到可旋转、可聚焦的空间地图 | Three.js + GeoJSON | 🚧 |
